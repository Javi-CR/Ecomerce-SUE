...
import 'favorities_model.dart';
export 'favorities_model.dart';

class FavoritiesWidget extends StatefulWidget {
  const FavoritiesWidget({super.key});

  @override
  State<FavoritiesWidget> createState() => _FavoritiesWidgetState();
}

class _FavoritiesWidgetState extends State<FavoritiesWidget> {
  late FavoritiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavoritiesModel());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          if (!listViewProductsRecord.favorito
                                              .contains(currentUserReference))
                                            FFButtonWidget(
                                              onPressed: () {
                                                print(
                                                    'GuardarFavorito pressed ...');
                                              },
                                              text: 'Guardar',
                                              icon: const Icon(
