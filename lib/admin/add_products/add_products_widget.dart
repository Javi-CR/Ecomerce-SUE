...
class _AddProductsWidgetState extends State<AddProductsWidget> {
  ...
  void initState() {
    ...
    _model.imgTextController ??= TextEditingController();
    _model.imgFocusNode ??= FocusNode();
  }
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      width: 300.0,
                                      child: TextFormField(
                                        controller: _model.imgTextController,
                                        focusNode: _model.imgFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
