...
import 'schema/facturacion_record.dart';
...
export 'schema/facturacion_record.dart';
...
/// Functions to query FacturacionRecords (as a Stream and as a Future).
Future<int> queryFacturacionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FacturacionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FacturacionRecord>> queryFacturacionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FacturacionRecord.collection,
      FacturacionRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FacturacionRecord>> queryFacturacionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
